...

{
  ...
  var btn = new Constructor({
    propsData: {
      icon: 'settings'
    }
  });
  btn.$mount('#test');
  var useElement = btn.$el.querySelector('use');
...
}
{
  ...
  var useELement = _btn.$el.querySelector('use');
...
}
{
  ...
  var _useELement = _btn2.$el.querySelector('use');

  var _href2 = _useELement.getAttribute('xlink:href');

  expect(_href2).to.eq('#i-loading');
...
}
{
  ...
  var svg = _btn3.$el.querySelector('svg');
...
},{"vue":"node_modules/vue/dist/vue.common.js","./button.vue":"src/button.vue","./icon.vue":"src/icon.vue","./button-group.vue":"src/button-group.vue","chai":"node_modules/chai/index.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
